-- Add inventory system tables (if not exist)
...
ALTER TABLE "inventory" DROP CONSTRAINT IF EXISTS "inventory_locationId_fkey";
...
ALTER TABLE "inventory_movements" DROP CONSTRAINT IF EXISTS "inventory_movements_inventoryId_fkey";
...
ALTER TABLE "batches" DROP CONSTRAINT IF EXISTS "batches_locationId_fkey";
...
ALTER TABLE "bundle_components" DROP CONSTRAINT IF EXISTS "bundle_components_parentSku_fkey";
ALTER TABLE "bundle_components" ADD CONSTRAINT "bundle_components_parentSku_fkey" FOREIGN KEY ("parentSku") REFERENCES "products"("sku") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "bundle_components" DROP CONSTRAINT IF EXISTS "bundle_components_childSku_fkey";
ALTER TABLE "bundle_components" ADD CONSTRAINT "bundle_components_childSku_fkey" FOREIGN KEY ("childSku") REFERENCES "products"("sku") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "purchase_order_items" DROP CONSTRAINT IF EXISTS "purchase_order_items_poId_fkey";
...
ALTER TABLE "purchase_order_items" DROP CONSTRAINT IF EXISTS "purchase_order_items_productId_fkey";
ALTER TABLE "purchase_order_items" ADD CONSTRAINT "purchase_order_items_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "demand_forecasts" DROP CONSTRAINT IF EXISTS "demand_forecasts_productId_fkey";
